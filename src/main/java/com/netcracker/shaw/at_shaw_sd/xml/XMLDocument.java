...
public class XMLDocument {
	...
	public XMLDocument parse(InputStream stream, String xpathString) {
		try {
    ...
    public XMLDocument parse(String response) {
        return parse(new ByteArrayInputStream(response.getBytes(StandardCharsets.UTF_8)), null);
    }
    
    public XMLDocument parse(InputStream stream) {
